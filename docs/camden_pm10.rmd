...
eval(parse(text = getURL('https://raw.githubusercontent.com/KCL-ERG/colour_schemes/master/pm10_laei2013_colours_breaks.R')))
...
panel_3     <- mapview(diff, maxpixels =  2018560,
                       legend = TRUE, map.types = c("OpenStreetMap.BlackAndWhite"),
                       at = seq(cellStats(diff, 'min'), cellStats(diff, 'max'), length = 17),
                       col.regions = pm10_laei2013_colours,
                            query.digits = 2,
                            query.type   = 'mousemove')
